...
function searchTreatmentCallback()
{
	...
	$.ajax({
		...
		success: function(response){
			var htmlString="";
			response.forEach(function(item,index){
				htmlString+='<div class="card-media"><div class="card-media-object-container"><div class="card-media-object" style="background-image: url('+item.hospitalimage+');"></div><span class="card-media-object-tag subtle">Trusted</span><ul class="card-media-object-social-list"></ul></div><div class="card-media-body"><div class="card-media-body-top"><span class="subtle">'+item.hospitalName+'</span><div class="card-media-body-top-icons u-float-right"><button class="btn btn-success" onclick="openSubmitEnquiry()">Contact Us</button></div></div><span class="card-media-body-heading">'
